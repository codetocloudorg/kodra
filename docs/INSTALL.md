...
> **💡 Tip:** If the command appears to hang, your network may have IPv6 connectivity issues. Use curl instead:
> ```bash
...
- **Install** — Fresh install with theme and app selection
...
| **CLI** | bat, eza, fzf, ripgrep, zoxide, jq |
