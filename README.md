...
[![Version](https://img.shields.io/badge/version-0.2.2-blue?style=flat-square)](VERSION)
...
> **💡 Tip:** If the command appears to hang, your network may have IPv6 issues. Use curl instead:
> ```bash
